...
export function Login({ singnUser }){
    ...
    return(
        <div className='h-full flex justify-center '>
            <div className='bg-brandColors-birdBlue lg:flex-1'></div>
            ...
            <div className="flex-1 flex justify-center items-center p-12 space-y-6">
                <div className='max-w-md flex-1'>
                    ...
                    <span className="text-sm text-brandColors-silver text-center">
                        Não tem conta? <a className="text-brandColors-birdBlue" href="/signup">Inscreva-se!!</a>
                    </span>
                </div>
            </div>
        </div>
